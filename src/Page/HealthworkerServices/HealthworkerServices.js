...
import { addHealthService, addProfessionService, getHealthService, getHealthworkerList, getProfessionService } from '../../Services/ApiServices'
import { Bars, Circles } from 'react-loader-spinner'


function HealthworkerServices() {
                                                ...
                                                <table className='w-full border-separate border-spacing-y-3'>
                                                    <thead>
                                                        <tr className='bg-white'>
                                                            ...
                                                            <th className='py-4 px-2 text-base font-medium whitespace-nowrap text-start first:rounded-l-lg last:rounded-r-lg'>Service Price (per day)</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                        {
                                                                ...
                                                                >
                                                                    <td className='text-start px-8 py-3 first:rounded-l-lg last:rounded-r-lg '>
                                                                        <div className='lg:whitespace-normal whitespace-nowrap lg:break-all break-normal'>
                                                                            <p className='text-base'>{item.professionalId || ""}</p>
                                                                        </div>
                                                                    </td>
                                                                    <td className='text-start lg:px-2 px-4 py-3 first:rounded-l-lg last:rounded-r-lg '>
                                                                        <div className='lg:whitespace-normal whitespace-nowrap lg:break-all break-normal'>
                                                                            <p className='text-base'>{item.professional || ""}</p>
                                                                        </div>
                                                                    </td>
                                                                    <td className='text-start lg:px-2 px-4 py-3 first:rounded-l-lg last:rounded-r-lg '>
                                                                        <div className='lg:whitespace-normal whitespace-nowrap lg:break-all break-normal'>
                                                                            <p className='text-base'>{item.pricePerDay || ""}</p>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                            ))
                            ...
                            <form onSubmit={handleSubmit}>
                                <div className='grid grid-cols-12'>
                                    <div className='col-span-12 md:mx-2 mx-0 my-3'>
                                        ...
                                        <input required type="text" name='professional' className='border-2 px-4 py-3 rounded-md w-full outline-[#00987C]' onChange={(e) => handleChange(e)} placeholder='Enter' />
                                    </div>
                                    <div className='col-span-12 md:mx-2 mx-0 my-3'>
                                        <p className='text-sm font-medium mb-3'>Service Price (per day)</p>
                                        <input required type="text" name='pricePerDay' className='border-2 px-4 py-3 rounded-md w-full outline-[#00987C]' onChange={(e) => handleChange(e)} placeholder='Enter' />
                                    </div>
                                </div>
...
export default HealthworkerServices