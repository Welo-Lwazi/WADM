                        ...
                        <form onSubmit={handleSubmit}>
                            <div className="grid grid-cols-12 fontNew md:px-[30px] px-[10px] bg-white overflow-auto">
                                <div className="col-span-12 py-4">
                                    <h1 className=' text-xl font-medium'>Add Terms & Conditions</h1>
                                </div>
                ...
                <Dialog.Panel>
                    <Dialog.Description className="rounded-none border-2 border-white">
                        <div className='flex justify-center text-center my-4 px-16 fontNew'>
                            <div>
                                <h1 className='text-xl font-semibold text-black mt-6'>Delete Terms & Conditions?</h1>
                                <p className='text-base text-gray-500 my-3'>Are you sure want to delete this Terms & Conditions?</p>
