        ...
        <>
            <div className='md:m-4 m-1 fontNew'>
                <div className='bg-white py-4 sm:px-8 px-3 rounded-lg'>
                    <div className='flex flex-wrap items-center justify-between border-b-2 pb-6 border-dashed'>
                        <h1 className='text-2xl font-semibold'>Troubleshooting Resource</h1>
                        <button onClick={() => setModalOpens(true)} type="submit" className="btn-primary bg-[#EA5F5F] px-3 py-2 mt-2 rounded-lg text-white text-base">
                            Add Troubleshooting Resource
                        </button>
                    </div>
                    <div className='mt-3'>
                        ...
                        <form onSubmit={handleSubmit}>
                            <div className="grid grid-cols-12 fontNew md:px-[30px] px-[10px] bg-white overflow-auto">
                                <div className="col-span-12 py-4">
                                    <h1 className=' text-xl font-medium'>Add Troubleshooting Resource</h1>
                                </div>
                ...
                <Dialog.Panel>
                    <Dialog.Description className="rounded-none border-2 border-white">
                        <div className='flex justify-center text-center my-4 px-16 fontNew'>
                            <div>
                                <h1 className='text-xl font-semibold text-black mt-6'>Delete Troubleshooting Resource?</h1>
                                <p className='text-base text-gray-500 my-3'>Are you sure want to delete this Troubleshooting Resource?</p>
